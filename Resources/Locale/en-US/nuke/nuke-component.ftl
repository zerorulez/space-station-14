...
nuke-component-announcement-armed = Atenção! O mecanismo de auto-destruição da estação foi ativo. {$time} segundos até a detonação.
nuke-component-announcement-unarmed = A auto-destruição da estação foi desativada! Tenha um bom dia!
nuke-component-announcement-send-codes = Atenção! Os códigos de auto-destruição foram enviados aos consoles da comunicação.
